...
class Peel {
 ...
 ~Peel(){
  	...
  	cout << "Destroying the Peel class instance (object) " << endl;
  }
...
int main(){
  ...
  cout << "Values in the object are " << tot.getX() << " and " << tot.getY() << " and name is " << tot.getName() << endl;

  changeValues(&tot);

  cout << "Values in the object are " << tot.getX() << " and " << tot.getY() << " and name is " << tot.getName() << endl;

  cout << "Values in the other object are " << (*sot).getX() << " and " << (*sot).getY() << " and name is " << (*sot).getName() << endl;
